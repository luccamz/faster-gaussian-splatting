...
namespace faster_gs::rasterization::kernels::metric_counts {
    ...
    // NOTE: metric_counts is a self-contained rasterization mode with its own copies of the
    // preprocess / depth-ordering / instance-building kernels, mirroring how kernels::forward,
    // kernels::inference and kernels::pruning_scores each carry their own. This avoids sharing a
    // header across translation units (no duplicate-symbol / dead-code issues, no anon namespaces).
